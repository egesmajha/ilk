...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AilkCharacter::Look);
	}
	else
	{
...
void AilkCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
