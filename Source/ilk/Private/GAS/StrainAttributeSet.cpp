...
{
    GAMEPLAYATTRIBUTE_REPNOTIFY(UStrainAttributeSet, GrowthTime, OldValue);
}
...
void UStrainAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    ...
    DOREPLIFETIME_CONDITION_NOTIFY(UStrainAttributeSet, GrowthTime, COND_None, REPNOTIFY_Always);
}
